...
/////////////////////////////////////////////////////////////////
// This method adds visible tiles from someTiles to either 
// fullDetailTiles or simplifiedTiles. Tiles that are not visible
// by aCamera are not added to fullDetailTiles or simplifiedTiles.
//
// Visible tiles are added to simplifiedTiles if and only if
// the tile is greater than simplifaicationDistanceInTiles from
// aCamera's position. Otherwise, visible tiles are added to
// fullDetailTiles.
...
{  
   ...
   [self drawSimplifiedTiles:simplifiedTiles];
   [self drawTiles:fullDetailTiles];
}
